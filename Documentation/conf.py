...
# -*- coding: utf-8 -*-
#
# Manual for Nkhyphenation documentation build configuration file, created by
# sphinx-quickstart on Sun Dec  1 16:07:10 2013.
#
...
project = 'Nkhyphenation'
copyright = '2013, Jost Baron'
...
html_theme_path = ['/home/jost/RestTools/ResourcesForSphinxAndDocutils/res/sphinx/themes']
...
htmlhelp_basename = 'ManualforNkhyphenationdoc'
...
latex_documents = [
  ('Index', 'ManualforNkhyphenation.tex', u'Manual for Nkhyphenation',
   u'Jost Baron', 'typo3manual'),
]
...
man_pages = [
    ('Index', 'manualfornkhyphenation', 'Manual for Nkhyphenation',
     ['Jost Baron'], 1)
]
...
texinfo_documents = [
  ('Index', 'ManualforNkhyphenation', 'Manual for Nkhyphenation',
   'Jost Baron', 'ManualforNkhyphenation', 'One line description of project.',
   'Miscellaneous'),
]
